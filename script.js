...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // --- MODAL DE IMAGEM POR HOVER APENAS SOBRE A IMAGEM ---
  const imageModal = document.getElementById('image-modal');
  const imageModalImg = document.getElementById('image-modal-img');
  const zoomableImages = document.querySelectorAll('.grid-image.zoomable');
  ...
  // O modal não mantém mais visibilidade ao passar o mouse sobre ele
  // O botão de fechar é redundante, mas pode ser mantido para acessibilidade
